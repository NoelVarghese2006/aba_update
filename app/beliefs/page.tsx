...
function Beliefs() {
  return (
    ...
    <div className={bs.className}><h1 className="flex justify-center items-center text-4xl mt-10">We Believe: </h1></div>
    <div className="p-[10vw] pl-[5vw] pt-[5vw] text-3xl">
      <div className="relative flex justify-center items-center min-w-screen">
        ...
        <FadeInSVG className="absolute translate-x-96" width={70} height={70} viewBox="0 0 24 24"><path fill="currentColor" d="M6 22h15v-2H6.012C5.55 19.988 5 19.805 5 19s.55-.988 1.012-1H21V4a2 2 0 0 0-2-2H6c-1.206 0-3 .799-3 3v14c0 2.201 1.794 3 3 3M8 7h3V5h2v2h3v2h-3v6h-2V9H8z"></path></FadeInSVG>
      </div>
      <div className="relative flex justify-center items-center min-w-screen">
      ...
      <div className="relative flex justify-center items-center min-w-screen">
        ...
        <FadeInSVG className="absolute opacity-10 translate-x-36 "  width={60} height={60} viewBox="0 0 512 512"><path fill="currentColor" d="M288 0c17.7 0 32 14.3 32 32v9.8c0 54.6-27.9 104.6-72.5 133.6l.2.3l56.8 80.3H392c15.1 0 29.3 7.1 38.4 19.2l43.2 57.6c10.6 14.1 7.7 34.2-6.4 44.8s-34.2 7.7-44.8-6.4L384 320h-97.4l92.3 142.6c9.6 14.8 5.4 34.6-9.5 44.3s-34.6 5.4-44.3-9.5L164.5 249.2c-2.9 9.2-4.5 19-4.5 29V352c0 17.7-14.3 32-32 32s-32-14.3-32-32v-73.8c0-65.1 39.6-123.7 100.1-147.9c36.2-14.5 59.9-49.5 59.9-88.5V32c0-17.7 14.3-32 32-32M112 32a48 48 0 1 1 0 96a48 48 0 1 1 0-96"></path></FadeInSVG>
      </div>
      <div className="relative flex justify-center items-center min-w-screen">
        ...
        <FadeInSVG className="absolute opacity-10 translate-x-36 " width={60} height={60} viewBox="0 0 24 24"><path fill="currentColor" d="m19 1l-1.26 2.75L15 5l2.74 1.26L19 9l1.25-2.74L23 5l-2.75-1.25M9 4L6.5 9.5L1 12l5.5 2.5L9 20l2.5-5.5L17 12l-5.5-2.5M19 15l-1.26 2.74L15 19l2.74 1.25L19 23l1.25-2.75L23 19l-2.75-1.26"></path></FadeInSVG>
      </div>
      <div className="relative flex justify-center items-center min-w-screen">
        ...
        <FadeInSVG className="absolute opacity-10 translate-x-36 "  width={60} height={60} viewBox="0 0 24 24"><path fill="currentColor" d="M9.06 1.93C7.17 1.92 5.33 3.74 6.17 6H3a2 2 0 0 0-2 2v2a1 1 0 0 0 1 1h9V8h2v3h9a1 1 0 0 0 1-1V8a2 2 0 0 0-2-2h-3.17C19 2.73 14.6.42 12.57 3.24L12 4l-.57-.78c-.63-.89-1.5-1.28-2.37-1.29M9 4c.89 0 1.34 1.08.71 1.71S8 5.89 8 5a1 1 0 0 1 1-1m6 0c.89 0 1.34 1.08.71 1.71S14 5.89 14 5a1 1 0 0 1 1-1M2 12v8a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-8h-9v8h-2v-8z"></path></FadeInSVG>
      </div>
      <div className="relative flex justify-center items-center min-w-screen">
      ...
      <div className="relative flex justify-center items-center min-w-screen">
        ...
        <FadeInSVG className="absolute opacity-10 translate-x-36 " width={70} height={70} viewBox="0 0 16 16"><path fill="currentColor" d="M8.999 6a3.5 3.5 0 0 0-3.464 3H5.5a2.5 2.5 0 0 0 0 5h7a2.5 2.5 0 0 0 0-5h-.037A3.5 3.5 0 0 0 9 6m-.212-3.18a.5.5 0 1 0-.883-.47l-.426.803a.5.5 0 0 0 .883.47zm-3.772-.747a.5.5 0 1 0-.957.293l.267.87a.5.5 0 0 0 .956-.293zM3 7c0 .604.179 1.166.486 1.637c.367-.259.787-.45 1.24-.551a4.51 4.51 0 0 1 3.56-3.03A3 3 0 0 0 3 7M1.82 4.214a.5.5 0 1 0-.47.883l.803.426a.5.5 0 0 0 .47-.883zm.416 4.463a.5.5 0 0 0-.293-.956l-.87.266a.5.5 0 1 0 .293.956z"></path></FadeInSVG>
      </div>
    </div>
    </div>
  )
