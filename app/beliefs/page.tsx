...
function Beliefs() {
  return (
    ...
    <div className="mt-20 p-[10vw] text-3xl">
      <div className="relative snap-start flex justify-center items-center min-h-screen min-w-screen -scroll-mt-20 md:-scroll-mt-0 md:-scroll-mb-20">
      ...
      <div className="relative snap-start flex justify-center items-center min-h-screen min-w-screen my-[100vh] -scroll-mt-20 md:-scroll-mt-0 md:-scroll-mb-20">
