...
export default function Home() {
  ...
  return (
    <div className={`h-[calc(100vh-74px)] overflow-y-scroll relative snap-start flex flex-col justify-center items-center min-w-screen -scroll-mb-20 bg-cover bg-center bg-no-repeat snap-y snap-mandatory bg-gradient-to-r from-white to-[#b5c9e5]`}>
      <div className='flex flex-col justify-center min-h-screen items-center snap-end mt-[200vh] mb-96'>
      ...
      >
      <div className='flex flex-col justify-center min-h-screen min-w-screen items-center snap-start bg-center bg-cover bg-no-repeat' style={{backgroundImage: "url('/church.png')"}}>
        <div className="flex justify-end items-center w-[85vw] overflow-x-hidden">
