...
function About() {
  return (
    <div>
        ...
        <div>As an assembly, our focus is on becoming more and more Christ-like in our conduct, reaching the unreached with His glorious Gospel, and abounding in Faith, Hope, and Love.</div>
        ...
        <div>Are you burdened with sins and wondering who can save you? Christ alone! "Nor is there salvation in any other, for there's no other name under heaven given among men by which we must be saved". (Acts 4:12)</div>
        <div>If you confess your sins, believe in Jesus Christ, and accept Him as the Lord of your life, you will be saved. To such that are saved, "he gave the right to be called the children of God". (John 1:12)</div>
